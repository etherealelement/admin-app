        ...
        <form className={styles.form} onSubmit={handleSubmit(submit)} {...props}>
            ...
            <div className={styles.formInner}>
                    ...
                    <span className={styles.errorContainer}>
                      ...
                      >
                        ...
                        <div className={styles.forgotPassword}>
                            <Link href={"/pages/forgot-password-page"} className={styles.forgotPasswordLink}>Forgot
                                password?</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.policy}>
                    ...
                    <Link href={"/"} className={styles.policyLink}>{descriptionLink}</Link>
                </div>

                <span className={styles.decor}><svg width="384" height="22" viewBox="0 0 384 22" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
