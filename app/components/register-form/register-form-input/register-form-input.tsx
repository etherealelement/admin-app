...
import { IRegisterForm } from '../register-form.props';
      ...
      <label className={styles.inputTitle}>
        <div className={styles.inputContainer}>
          ...
          <div className={styles.errors}>
           ...
           { errors.first_name?.message && configType === "first_name" && (
              <div className={styles.errorMessage}>
                <span>
                  <svg
                    width="14"
          ...
          { errors.last_name?.message && configType === "last_name" && (
              <div className={styles.errorMessage}>
                <span>
                  <svg
                    width="14"
            ...
            { errors.phone?.message && configType === "phone" && (
              <div className={styles.errorMessage}>
                <span>
                  <svg
                    width="14"
              ...
              { errors.username?.message && configType === "username" && (
              <div className={styles.errorMessage}>
                <span>
                  <svg
                    width="14"
