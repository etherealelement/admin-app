...
import { RegisterFormInputsProps } from './login-form-input.props';
...
export const LoginFormInput: FC<RegisterFormInputsProps> = ({typeInput,labelName,placeholderName,configType,fieldNameInput,sizeInput,type,className,...props}: RegisterFormInputsProps): JSX.Element => {
  const {formState: {errors}} = useFormContext<IRegisterForm>();
      ...
      <label className={styles.inputTitle}>
        <div className={styles.inputContainer}>
          ...
          <div className={styles.errors}>
            { errors.email?.message && configType === "email" && (
            ...
            { errors.password?.message && configType === "password" && (
              <div className={styles.errorMessage}>
                <span>
                  <svg
                    width="14"
